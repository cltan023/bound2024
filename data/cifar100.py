...
class CIFAR100Partial(datasets.CIFAR100):
    def __init__(self, example_per_class=-1, num_classes=100, categories=[], **kwargs):
        super(CIFAR100Partial, self).__init__(**kwargs)
